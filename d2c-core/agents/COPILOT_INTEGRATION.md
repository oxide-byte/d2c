...
1. Commit the d2c-core/agents directory to the repository and push to GitHub.
2. (Copilot CLI / Copilot Extensions) Register agent manifests by adding an index or agent registry file (e.g., d2c-core/agents/agents.json) listing available agents and their manifests.
...
- d2c-core/agents/agents.json -> [{"name":"d2c-initialize","path":"d2c-initialize/agent.toml"}]
